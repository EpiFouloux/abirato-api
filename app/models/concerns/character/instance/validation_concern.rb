module Character::Instance::ValidationConcern
  ...
  included do
    ...
    belongs_to :prestigious_class, class_name: "Class", foreign_key: 'character_prestigious_class_id'
    belongs_to :legendary_class, class_name: "Class", foreign_key: 'character_legendary_class_id'
